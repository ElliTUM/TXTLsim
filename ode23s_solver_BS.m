function totalError=ode23s_solver_BS(param,c_0,data,errW,cutFFT)
...
[simTime,simData]=ode23s(@(t,c)define_BS(t,c,k),tSpanSim,c_0,options);
...
simData22=simData(:,22);
simData23=simData(:,23);
simData24=simData(:,24);
simData25=simData(:,25);
simData26=simData(:,26);
simData27=simData(:,27);
simData28=simData(:,28);
simData29=simData(:,29);
simData30=simData(:,30);
simData31=simData(:,31);
figure(1)
