function sol=Fitfkt_T2(param,c_0,data,errW,cutFFT)
...
[nparam,fval,exitflag,output]=fmincon(@(param)ode23s_solver_T2(param,c_0,data,errW,cutFFT),bestparam,[],[],[],[],lb,ub,[],options);
output
